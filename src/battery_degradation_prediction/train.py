...
from battery_degradation_prediction.plot_model import plot_train_val_loss, parity_plot, plot_future_capacity, plot_future_capacities
...
def main():
    ...
    path = "../../data/B0005.csv"
    num_data = int(1e7)
    df_discharge = get_clean_data(path, int(num_data)) # 10: 11140, 50: 113930, 100:316545, 159: 556018
    feature_names = [
        "cycle",
        "voltage_measured",
        "current_measured",
    ...
    plot_future_capacities(df_feature, input_shape, model, X_scaler, y_scaler, future_cycle, window_size)
    """
